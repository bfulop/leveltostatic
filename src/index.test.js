...
describe('walking through the db', () => {
  beforeAll(done => {
    db.batch()
      .put('note:aaa1', 'note_aaa1_data')
      .put('note:aaa2', 'note_aaa2_data')
      .put('note:aaa3', 'note_aaa3_data')
      .put('note:baa1', 'note_baa1_data')
      .put('note:baa2', 'note_baa2_data')
      .put('note:baa3', 'note_baa3_data')
  ...
  test('calls a creaateNotePage', done => {
    expect(createNotePage.mock.calls[0][0]).toEqual({
      notedata: 'note_aaa1_data',
